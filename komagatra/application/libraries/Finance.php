...
class Finance
{
     ...
     * @return float
     */
    public static function pmt($rate, $periods,  $present_value, $future_value = 0,$beginning = false)
    {
        $when = $beginning ? 1 : 0;
     ...
     * @return float
     */
    public static function ipmt( $rate,  $period,  $periods,  $present_value,  $future_value = 0,  $beginning = false)
    {
     ...
     * @return float
     */
    public static function ppmt( $rate,  $period,  $periods,  $present_value,  $future_value = 0,  $beginning = false)
    {
        $payment = self::pmt($rate, $periods, $present_value, $future_value, $beginning);
     ...
     * @return float
     */
    public static function periods( $rate,  $payment,  $present_value,  $future_value,  $beginning = false)
    {
        $when = $beginning ? 1 : 0;
     ...
     * @return float
     */
    public static function aer( $nominal,  $periods)
    {
        if ($periods == 1) {
            return $nominal;
        }
     ...
     * @return float
     */
    public static function nominal( $aer,  $periods)
    {
        if ($periods == 1) {
            return $aer;
        }
     ...
     * @return float
     */
    public static function pv( $rate,  $periods,  $payment,  $future_value,  $beginning = false)
    {
        $when = $beginning ? 1 : 0;
     ...
     * @return float
     */
    public static function rate( $periods,  $payment,  $present_value,  $future_value,  $beginning = false,  $initial_guess = 0.1)
    {
        $when = $beginning ? 1 : 0;
     ...
     * @return float
     */
    public static function irr( $values,  $initial_guess = 0.1)
    {
     ...
     * @return float
     */
    public static function payback( $values,  $rate = 0.0)
    {
        $last_outflow = -1;
        for ($i = 0; $i < sizeof($values); $i++) {
            if ($values[$i] < 0) {
     ...
     * @return float
     */
    public static function profitabilityIndex( $values,  $rate)
    {
        $inflows  = array();
        $outflows = array();
