...
class Pengeluaran_bank_m extends CI_Model {
	...
	function lap_data_pengeluaran() {
		...
		WHERE akun='Pengeluaran' AND type = 'bank' ";
	...
	function get_data_transaksi_ajax($offset, $limit, $q='', $sort, $order) {
		...
		$result['count'] = $this->general_m->kocak_model('bank',0,$q)->num_rows();
		$result['data'] = $this->general_m->kocak_model('bank',0,$q,$sort,$order,$limit,$offset)->result();
