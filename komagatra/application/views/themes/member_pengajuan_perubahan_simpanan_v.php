...
<head>
	<meta charset="UTF-8">
	<title>Pengajuan Perubahan Simpanan - SIFOR KOPJAM</title>
	...
	<div class="row">
		<div class="box box-primary">
			<div class="box-body" style="min-height: 500px;">
				<div>
					<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Data Pengajuan Perubahan Simpanan </p>
				</div>
				...
				<table 
					...
					data-toggle="table"
					data-id-field="id"
					data-url="<?php echo site_url('member/ajax_pengajuan_perubahan_simpanan'); ?>" 
					...
					<thead>
						<tr>
							...
							<th data-field="tgl_cair" data-sortable="false" data-align="center" data-halign="center" data-valign="middle" data-formatter="status_ft">Tanggal Cair</th>
				...
				<div id="tb">
					<a href="<?php echo site_url('member/pengajuan_perubahan_simpanan_baru'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
				</div>
				<?php
