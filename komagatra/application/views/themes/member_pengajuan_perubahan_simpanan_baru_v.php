...
<head>
	<meta charset="UTF-8">
	<title>Pengajuan Perubahan Simpanan Baru - SIFOR KOPJAM</title>
		...
		<div class="col-md-12">
			<div class="box box-solid box-primary">
				<div class="box-header">
					<h3 class="box-title">Formulir Pengajuan Perubahan Simpanan </h3>
				</div>
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						echo form_label('Simpanan Sebelumnya', 'jumlah');
					...
					<div class="form-group">
						...
						echo form_label('Nominal Perubahan', 'nominal');
						echo form_input($data);
						echo form_error('nominal', '<p style="color: red;">', '</p>');
						?>
...
<script type="text/javascript">
	...
	function get_simpanan(jenis) {
		$.ajax({
			url: '<?php echo site_url('member/get_simpanan_bulan_by_anggota')?>',
			type: 'POST',
			dataType: 'json',
			data: {'jenis': jenis}
		})
