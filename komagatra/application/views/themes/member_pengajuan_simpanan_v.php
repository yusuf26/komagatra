...
<head>
	<meta charset="UTF-8">
	<title>Pengajuan Simpanan - SIFOR KOPJAM</title>
		...
		<div class="box box-primary">
			<div class="box-body" style="min-height: 500px;">
				...
				<table 
					...
					data-toggle="table"
					data-id-field="id"
					data-url="<?php echo site_url('member/ajax_pengajuan_simpanan'); ?>" 
				...
				<div id="tb">
					<a href="<?php echo site_url('member/pengajuan_simpanan_baru'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
				</div>
				<?php
