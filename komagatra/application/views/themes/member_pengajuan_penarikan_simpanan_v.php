...
<head>
	<meta charset="UTF-8">
	<title>Pengajuan Penarikan Simpanan - SIFOR KOPJAM</title>
	...
	<div class="row">
		<div class="box box-primary">
			<div class="box-body" style="min-height: 500px;">
				<div>
					<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Data Pengajuan Penarikan Simpanan </p>
				</div>
				...
				<table 
					...
					data-toggle="table"
					data-id-field="id"
					data-url="<?php echo site_url('member/ajax_pengajuan_penarikan_simpanan'); ?>" 
				...
				<div id="tb">
					<a href="<?php echo site_url('member/pengajuan_penarikan_simpanan_baru'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
				</div>
				<?php
