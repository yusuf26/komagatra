...
<head>
	<meta charset="UTF-8">
	<title>Pengajuan Pinjaman - SIFOR KOPJAM</title>
				...
				<table 
					...
					<thead>
						<tr>
							...
							<th data-field="urutan" data-sortable="true" data-valign="middle" data-align="center" data-halign="center" >Urutan</th>
							...
							<th data-field="tgl_cair" data-sortable="false" data-align="center" data-halign="center" data-valign="middle">Tanggal Cair</th>
						</tr>
					</thead>
				</table>
				<div id="tb">
					<a href="<?php echo site_url('member/pengajuan_baru'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
				</div>
				<?php
...
<script type="text/javascript">
	...
	function status_ft(value, row, index) {
		...
		if(value == 1) {
			...
			nsi_out += '<br>Perkiraan Tgl Cair: ' + row.tgl_cair_txt;
		}
		if(value == 2) {
