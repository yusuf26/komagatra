...
<a href="<?php echo site_url();?>" class="logo">
			<!-- Add the class icon to your logo image or logo icon to add the margining -->
			 <div style="text-align:center;"><img height="50" src="<?php echo base_url().'assets/theme_admin/img/tulisan2.png'; ?>"></div>
		</a>
<!-- /.search form -->
...
<li  class="treeview <?php 
	...
	$menu_trans_arr= array('pemasukan_kas','pengeluaran_kas','lap_trans_kas');
	...
	<ul class="treeview-menu">
		<li class="<?php if ($this->uri->segment(1) == 'pemasukan') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pemasukan"> <i class="fa fa-folder-open-o"></i> Pemasukan </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pengeluaran') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengeluaran"> <i class="fa fa-folder-open-o"></i> Pengeluaran </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pemasukan_kas') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pemasukan_kas"> <i class="fa fa-folder-open-o"></i> Jurnal Pemasukan </a></li>

		<li class="<?php if ($this->uri->segment(1) == 'pengeluaran_kas') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>pengeluaran_kas"> <i class="fa fa-folder-open-o"></i> Jurnal Pengeluaran </a></li>
		<li class="<?php if ($this->uri->segment(2) == 'kas') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>lap_trans_kas/kas"> <i class="fa fa-folder-open-o"></i> Laporan Kas </a></li>
...
<li  class="treeview <?php 
	 $menu_trans_arr= array('pemasukan_bank','pengeluaran_bank','lap_trans_kas');
	 // $menu_trans_arr= array('pemasukan_bank','pengeluaran_bank', 'transfer_bank');
	 if(in_array($this->uri->segment(1), $menu_trans_arr)) {echo "active";}?>">

	<a href="#">
		<img height="20" src="<?php echo base_url().'assets/theme_admin/img/bank.png'; ?>">
		<span>Transaksi Bank</span>
		<i class="fa fa-angle-left pull-right"></i>
	</a>
	<ul class="treeview-menu">
		<li class="<?php if ($this->uri->segment(1) == 'pemasukan_bank') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pemasukan_bank"> <i class="fa fa-folder-open-o"></i> Jurnal Pemasukan </a></li>

		<li class="<?php if ($this->uri->segment(1) == 'pengeluaran_bank') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>pengeluaran_bank"> <i class="fa fa-folder-open-o"></i> Jurnal Pengeluaran </a></li>
		<li class="<?php if ($this->uri->segment(2) == 'bank') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>lap_trans_kas/bank"> <i class="fa fa-folder-open-o"></i> Laporan Bank </a></li>
		<!-- <li class="<?php if ($this->uri->segment(1) == 'transfer_bank') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>transfer_kas"> <i class="fa fa-folder-open-o"></i> Transfer </a></li> -->
	</ul>
</li>
<!-- <li class="<?php 
	 $menu_home_arr= array('transfer_kas', '');
	 if(in_array($this->uri->segment(1), $menu_home_arr)) {echo "active";}?>">
		<a href="<?php echo base_url(); ?>transfer_kas">
			<img height="20" src="<?php echo base_url().'assets/theme_admin/img/transfer.png'; ?>"> <span>Transfer</span>
		</a>
</li> -->
<?php } ?>
...
<!-- Menu Simpanan -->
<li  class="treeview <?php 
	 $menu_trans_arr= array('simpanan','penarikan','pengajuan_simpanan','pengajuan_penarikan_simpanan','pengajuan_perubahan_simpanan');
	 if(in_array($this->uri->segment(1), $menu_trans_arr)) {echo "active";}?>">
	...
	<ul class="treeview-menu">
		<li class="<?php if ($this->uri->segment(1) == 'pengajuan_simpanan' && $this->uri->segment(2) == 'tambah') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan_simpanan/tambah"> <i class="fa fa-plus"></i> Tambah Pengajuan Simpanan </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pengajuan_simpanan' && $this->uri->segment(2) == '') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan_simpanan"> <i class="fa fa-folder-open-o"></i> Pengajuan Simpanan </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pengajuan_penarikan_simpanan/tambah' && $this->uri->segment(2) == 'tambah') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan_penarikan_simpanan/tambah"> <i class="fa fa-plus"></i> Tambah Pengajuan Penarikan Simpanan </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pengajuan_penarikan_simpanan' && $this->uri->segment(2) == '') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan_penarikan_simpanan"> <i class="fa fa-folder-open-o"></i> Pengajuan Penarikan Simpanan </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pengajuan_perubahan_simpanan/tambah' && $this->uri->segment(2) == 'tambah') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan_perubahan_simpanan/tambah"> <i class="fa fa-plus"></i> Tambah Pengajuan Perubahan Simpanan </a></li>
		<li class="<?php if ($this->uri->segment(1) == 'pengajuan_perubahan_simpanan' && $this->uri->segment(2) == '') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan_perubahan_simpanan"> <i class="fa fa-folder-open-o"></i> Pengajuan Perubahan Simpanan </a></li>
...
<ul class="treeview-menu">
	<li class="<?php if ($this->uri->segment(1) == 'pengajuan' && $this->uri->segment(2) == 'tambah') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan/tambah"> <i class="fa fa-plus"></i> Tambah Pengajuan Pinjaman </a></li>
	<li class="<?php if ($this->uri->segment(1) == 'pengajuan' && $this->uri->segment(2) == ''){ echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>pengajuan"> <i class="fa fa-folder-open-o"></i> Data Pengajuan </a></li>
	<?php if($level != 'pinjaman') { ?>
...
<li  class="treeview <?php 
	...
	<?php } ?>
		...
		<li class="<?php if ($this->uri->segment(1) == 'uang_makan') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>uang_makan"> <i class="fa fa-folder-open-o"></i> Uang Makan </a></li>
...
<!-- Master data -->
<li  class="treeview <?php 
$menu_data_arr= array('jenis_simpanan','jenis_akun','jenis_kas','jenis_angsuran','jenis_pinjaman','data_barang','anggota','user','data_departement');
...
<ul class="treeview-menu">
	<?php if($level == 'admin') { ?>
		...
		<li class="<?php if ($this->uri->segment(1) == 'data_departement') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>data_departement"> <i class="fa fa-folder-open-o"></i> Data Direktorat </a></li>
	<?php } ?>
