...
title="Data Transaksi Pemasukan Bank" 
style="width:auto; height: auto;" 
url="<?php echo site_url('pemasukan_bank/ajax_list'); ?>" 
...
<div id="tb" style="height: 35px;">
	<div style="vertical-align: middle; display: inline; padding-top: 15px;">
		<a href="<?php echo site_url('pemasukan_bank/tambah');?>" class="easyui-linkbutton" iconCls="icon-add" plain="true" >Tambah </a>
	...
	<div class="pull-right" style="vertical-align: middle;">
		...
		<div id="filter_tgl" class="input-group" style="display: inline;" >
			<select class="form-control" id="select-kas" onchange="doSearch()" style="width:150px;font-size: 12px;height: 30px;">
...
<!-- Dialog Form -->
<div id="dialog-form" class="easyui-dialog" show= "blind" hide= "blind" modal="true" resizable="false" style="width:370px; height:340px; padding-left:20px; padding-top:20px; " closed="true" buttons="#dialog-buttons" style="display: none;">
	<form id="form" method="post" novalidate>
		<table style="height:200px" >
			...
			<tr style="height:35px" id="dari-akun">
				<td>Dari Akun</td>
				<td>:</td>
				<td>
...
function cetak () {
	...
	if(row){
		...
		var win = window.open('<?php echo site_url("cetak/cetak_laporan/1/bank/?kode_transaksi=' + kode_transaksi + '&tgl_dari=' + tgl_dari + '&tgl_sampai=' + tgl_sampai + '"); ?>');
		if (win) {
			win.focus();
		} else {
		...
		$.ajax({
			...
			success	: function(result){
				if(result.ok) {
					...
					var win = window.open('<?php echo site_url("cetak/cetak_laporan/1/bank/'+row.tbl+'?kode_transaksi=' + kode_transaksi+'&tgl_dari=&tgl_sampai="); ?>','_blank');
					if (win) {
						win.focus();
					} else {
						alert('Popup jangan di block');
