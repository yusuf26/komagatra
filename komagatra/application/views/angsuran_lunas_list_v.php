...
<div id="dialog-form" class="easyui-dialog" show= "blind" hide= "blind" modal="true" resizable="false" style="width:400px; height:340px; padding: 20px 25px" closed="true" buttons="#dialog-buttons" style="display: none;">
	<form id="form" method="post" novalidate>
		<input type="hidden" id="total_bunga" name="total_bunga" value="" />
		<input type="hidden" id="anggota_id" name="anggota_id" value="" />
		<table>
...
function create(){
	...
	jQuery('#anggota_id').val(<?php echo  $row_pinjam->anggota_id; ?>);
	...
	$.ajax({
		...
		success	: function(result) {
			...
			if(result.total_tagihan <= 0) {
				...
				$('#total_bunga').val(result.total_bunga);
