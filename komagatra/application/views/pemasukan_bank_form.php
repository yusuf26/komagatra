...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    ...
    <br />
  <!-- List group -->
    <form id="form-submit" action="<?php echo site_url('pemasukan');?>" method="post"  class="form-horizontal">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <select class="form-control" id="jenis" name="jenis">
                            ...
                            <option value="1">Pembayaran Angsuran</option>
                            <option value="2">Setoran Simpanan</option>
                            <option value="3">Pelunasan Pinjaman</option>
            ...
            <li class="list-group-item">
                <div class="row">
                    ...
                    <div class="col-sm-6" id="box-ajuan" style="display: none;">
                        <label class="">Pinjaman<span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Nomor Pinjaman" name="pinjaman_val" readonly="" id="pinjaman_val">
                    ...
                    <div class="col-sm-6" id="box-ajuan2" style="display: none;">
                        <label class="">Pengajuan<span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Nomor Pengajuan" name="pengajuan_id" readonly="" id="pengajuan_id">
                            <span class="input-group-btn"> 
                                <button class="btn btn-primary" type="button" id="btn-cari-ajuan2">Cari</button>
                            </span>
                        </div>
                    </div>
                    <div class="col-sm-5">
...
<div class="modal fade" id="tablePengajuan2" tabindex="-1" role="dialog" åå>
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
        <table class="table table-striped table-bordered" id="ajax-table-pengajuan" style="width:100%;">
            <thead>
                <tr>
                    <th>Jenis ID</th>
                    <th>Ajuan ID</th>
...
<script type="text/javascript">
   ...
   var table = $('#table-pemasukan').DataTable({ 
            ...
            "order": [], 
            "ajax": {
                "url": "<?php echo site_url('pemasukan/ajax_list')?>",
                "type": "POST",
                "data": function ( d ) {
        ...
        var table_pinjaman = $('#ajax-table-pinjaman').DataTable({ 
                "ajax": {
                    "url": "<?php echo site_url('pemasukan/table_angsuran')?>",
                    "type": "POST",
                    "data": function ( d ) {
                        d.jenis = $('#jenis').val();
                    }
        ...
        var table_pengajuan = $('#ajax-table-pengajuan').DataTable({ 
                "ajax": {
                    "url": "<?php echo site_url('pemasukan/table_pengajuan')?>",
                    "type": "POST",
                },
                "columnDefs": [ {
                    "targets": -1,
        ...
        function load_table_pinjaman()
        {
            ...
            $('#ajax-table-pinjaman tbody').on( 'click', 'button', function () {
                ...
                $('#pinjaman_id').val(table_data_pinjaman[0]);
                $('#pinjaman_val').val(table_data_pinjaman[1]);
                $('#content-akun').html('');
                addAkun(48,'D',table_data_pinjaman[9]);
                $('#tablePengajuan').modal('hide');
            } );
        }

        function load_table_pengajuan()
        {
            
            table_pengajuan.ajax.reload();
            $('#ajax-table-pengajuan tbody').on( 'click', 'button', function () {
                var table_data_pengajuan = table_pengajuan.row( $(this).parents('tr') ).data();
                // console.log(table_data_pinjaman[0]);
                $('#pengajuan_id').val(table_data_pengajuan[1]);
                $('#content-akun').html('');
                addAkun(table_data_pengajuan[0],'D',table_data_pengajuan[5]);
                $('#tablePengajuan2').modal('hide');
            } );
        }
        ...
        $('#btn-cari-ajuan2').click(function(){
            $('#tablePengajuan2').modal('show');
            load_table_pengajuan();
        });
   ...
   function printView()
   {
    ...
    $('#form-submit').submit(function(event){
    	...
    	if(kas_id != ''){
    		$.ajax({
				type	: "POST",
				url		: "<?php echo site_url('pemasukan/submit_form'); ?>",
				dataType : 'json',
				data: $(this).serialize(),
				success	: function(result){
