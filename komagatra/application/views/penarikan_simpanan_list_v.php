...
<!-- Data Grid -->
<table   id="tbl-u" 
title="Data Pengajuan Penarikan Simpanan" 
style="width:auto; height: auto;" 
url="<?php echo site_url('pengajuan_penarikan_simpanan/ajax_list'); ?>" 
...
function save() {
	...
	if (isValid) {
		...
		$.ajax({
			type	: "POST",
			url: url,
			data	: {data:row, ket:ket, tgl_transaksi:tgl_transaksi,kas:kas},
			dataType : 'json',
