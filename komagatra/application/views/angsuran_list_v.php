...
$tagihan = $ags_per_bulan * $row_pinjam->lama_angsuran;
...
<?php
	if($row_pinjam->lunas == 'Belum'){
		echo '<a href="'.site_url('angsuran_lunas').'/index/'.$row_pinjam->id.'" id="btn-lunas" class="btn btn-sm btn-success"><i class="fa fa-check-square-o"></i> Validasi Lunas</a>';
	}
			...
			<tr>
				...
				<td>
					...
					<tr>
						...
						<td> : </td>
						<td class="h_kanan"> <?php echo number_format($pokok_angsuran); ?></td>
					</tr>
					<tr>
						<td> Biaya dan Bunga</td>
						<td> : </td>
						<td class="h_kanan"> <?php echo number_format($biaya_bunga); ?></td>
					</tr>
					<tr>
						<td> Jumlah Angsuran </td> 
						<td> : </td>
						<td class="h_kanan"><?php echo number_format(nsi_round($ags_per_bulan)); ?></td>
					</tr>
					</table>
				</td>			
			</tr>
...
<thead>
	<tr>
		...
		<th data-options="field:'id_txt', width:'19', halign:'center', align:'center'">Kode </th>
		<th data-options="field:'tgl_bayar_txt', width:'30', halign:'center', align:'center'">Tanggal Bayar</th>
	...
	<form id="form" method="post" novalidate>
		<table>
			...
			<tr style="height:30px">
				<td> Jumlah Angsuran</td>
				<td> : </td>
				<td> <div class="inputform"><?php echo number_format((nsi_round($ags_per_bulan))); ?></div>
					<input type="hidden" id="angsuran" name="angsuran" value="<?php echo ($ags_per_bulan); ?>" readonly="readonly" />
				</td>
			</tr>
			<tr style="height:30px">
				<td> Sisa Tagihan</td>
			...
			<tr style="height:30px">
				...
				<input type="hidden" id="bunga_pinjaman" name="bunga_pinjaman" value="<?php echo $biaya_bunga;?>" />
				<input type="hidden" id="anggota_id" name="anggota_id" value="<?php echo $row_pinjam->anggota_id;?>" />
			<tr style="height:30px">
				<td> Simpan Ke Kas</td>
				<td> :</td>
				<td>
...
<script type="text/javascript">
	...
	function create() {
		...
		jQuery('#angsuran').val('<?php echo number_format(($ags_per_bulan)); ?>');
