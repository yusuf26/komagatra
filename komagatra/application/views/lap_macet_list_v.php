...
<p style="text-align:center; font-size: 15pt; font-weight: bold;"> Laporan Kredit Macet Periode <?php echo $txt_periode; ?> </p>
	<table  class="table table-bordered">
		<tr class="header_kolom">
			...
			<th style="width:15%; vertical-align: middle; text-align:center"> Bulan Macet  </th>
			<!-- <th style="width:10%; vertical-align: middle; text-align:center"> Lama Pinjam  </th> -->
			<th style="width:10%; vertical-align: middle; text-align:center"> Jumlah Gagal Bayar  </th>
	...
	echo '<tr bgcolor='.$warna.'>
				...
				<td class="h_tengah">'.$bulan[date('m',strtotime($tgl_tempo))].'</td>
