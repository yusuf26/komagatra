...
<thead>
	<tr>
		...
		<th data-options="field:'tipe', width:'15', halign:'center', align:'center'" hidden="true">Tipe</th>
		<th data-options="field:'tipe_txt', width:'15', halign:'center', align:'center'">Tipe</th>
			...
			<tr>
				<td>
					<table>
						...
						<tr style="height:35px" id="block-barang">
							<td>Nama Barang</td>
							<td>:</td>
							<td>
						...
						<tr style="height:35px">
							<td id="title-harga">Harga Barang</td>
							<td>:</td>
							<td>
...
$(document).ready(function() {
	...
	$('#tipe').change(function(){
		if($(this).val() == 2){
			$('#block-barang').hide();
			$('#title-harga').text('Jumlah Pinjaman');
...
function create(){
	...
	jQuery('#tipe option[value="1"]').prop('selected', true);
